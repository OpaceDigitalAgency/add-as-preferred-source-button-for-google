# Google Preferred Sources button — copy-paste recipes
...
No npm package needed. Each recipe adds Google'\''s Preferred Sources button to a platform using the official two-line auto mode, with the documented deeplink as the no-JS fallback.

| Platform | Recipe |
|---|---|
| Hugo | [hugo/](hugo/README.md) — params-driven partial |
| Jekyll | [jekyll/](jekyll/README.md) — `_includes` file |
| Eleventy | [eleventy/](eleventy/README.md) — shortcode |
| Ghost | [ghost/](ghost/README.md) — code injection |
| Webflow | [webflow/](webflow/README.md) — custom code + embed |
| Framer | [framer/](framer/README.md) — code component |
| Shopify | [shopify/](shopify/README.md) — Liquid snippet |

Using a framework instead? The npm packages cover React, Vue, Svelte, Astro and plain JS — see the [repo root](../README.md).
